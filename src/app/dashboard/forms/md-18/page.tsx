...
export default function MD18Page() {
  ...
  async function handleGenerate() {
    ...
    setStatusMsg(`Generating MD-18 documents archive...`);
    setStatusType("info");
    ...
    try {
      ...
      setStatusMsg(`MD-18 documents generated successfully! Click Download ZIP to save.`);
  ...
  function handleDownload() {
    ...
    a.href = downloadUrl;
    a.download = "MD-18_Documents.zip";
    ...
    <div className="p-8 max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-surface border border-border rounded-2xl p-6 shadow-sm">
        ...
        <p className="text-sm text-muted mb-6">
          This will generate a complete set of MD-18 application templates bundled into a single ZIP archive.
        </p>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {[
              "MD-18.docx",
              "MD-18_02_Medical_Officer_Recommendation.docx",
              "MD-18_03_Medical_Superintendent_Head_Certificate.docx"
            ].map((filename, i) => (
