...
export default function MD20Page() {
  ...
  async function handleGenerate() {
    ...
    setStatusMsg(`Generating MD-20 documents archive...`);
    setStatusType("info");
    ...
    try {
      ...
      setStatusMsg(`MD-20 documents generated successfully! Click Download ZIP to save.`);
  ...
  function handleDownload() {
    ...
    a.href = downloadUrl;
    a.download = "MD-20_Documents.zip";
    ...
    <div className="p-8 max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-surface border border-border rounded-2xl p-6 shadow-sm">
        ...
        <p className="text-sm text-muted mb-6">
          This will generate a complete set of MD-20 application templates bundled into a single ZIP archive.
        </p>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {[
              "MD-20.docx",
              "MD-20_Supporting_01_Bona_Fide_Personal_Use_Declaration.docx",
              "MD-20_Supporting_02_Registered_Medical_Practitioner_Prescription.docx"
            ].map((filename, i) => (
