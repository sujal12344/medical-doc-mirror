...
export default function MD22Page() {
  ...
  async function handleGenerate() {
    ...
    setStatusMsg(`Generating MD-22 documents archive...`);
    setStatusType("info");
    
    try {
      const res = await fetch(`/api/documents/${docId}/generate-md22`, {
        method: "POST",
      ...
      setStatusMsg(`MD-22 documents generated successfully! Click Download ZIP to save.`);
  ...
  function handleDownload() {
    ...
    a.href = downloadUrl;
    a.download = "MD-22_Documents.zip";
    ...
    return (
      <div className="p-8 max-w-4xl mx-auto flex items-center justify-center min-h-[400px]">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-muted">Loading MD-22 details...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="p-8 max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2 text-sm text-muted mb-2">
            ...
            <span className="text-foreground font-medium">MD-22 Form</span>
          </div>
          <h1 className="text-2xl font-bold text-foreground flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-[var(--accent)]/10 flex items-center justify-center text-[var(--accent)]">
              <FileText className="w-4 h-4" />
            </div>
            MD-22 Form Generation
          </h1>
          <p className="text-sm text-muted mt-1">
            Grant of permission to conduct clinical investigation of an investigational medical device. Download the required templates below.
          </p>
        </div>
      </div>
      ...
      <div className="bg-surface border border-border rounded-2xl p-6 shadow-sm">
        ...
        <p className="text-sm text-muted mb-6">
          This will generate a complete set of MD-22 clinical investigation application templates bundled into a single ZIP archive.
        </p>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {[
              "01_MD-22_Cover_Letter_Template.docx",
              "02_Official_Form_MD-22_Template.docx",
              "03_MD-22_Device_Classification_Justification_Template.docx",
              "04_MD-22_Design_Analysis_Report_Template.docx",
              "05_MD-22_Sponsor_Principal_Investigator_Agreement_Template.docx",
              "06_MD-22_AE_SAE_Reporting_Forms_Template.docx",
              "07_MD-22_Investigator_Brochure_Template.docx",
              "08_MD-22_Clinical_Investigation_Plan_Template.docx",
              "09_MD-22_Case_Report_Form_Template.docx",
              "10_MD-22_Patient_Information_and_Informed_Consent_Template.docx",
              "11_MD-22_Investigator_Undertaking_Template.docx"
            ].map((filename, i) => (
