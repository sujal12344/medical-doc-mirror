...
export default function MD26Page() {
  ...
  async function handleGenerate() {
    ...
    setStatusMsg(`Generating MD-26 documents archive...`);
    setStatusType("info");
    
    try {
      const res = await fetch(`/api/documents/${docId}/generate-md26`, {
        method: "POST",
      ...
      setStatusMsg(`MD-26 documents generated successfully! Click Download ZIP to save.`);
  ...
  function handleDownload() {
    ...
    a.href = downloadUrl;
    a.download = "MD-26_Documents.zip";
    ...
    return (
      <div className="p-8 max-w-4xl mx-auto flex items-center justify-center min-h-[400px]">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-muted">Loading MD-26 details...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="p-8 max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2 text-sm text-muted mb-2">
            ...
            <span className="text-foreground font-medium">MD-26 Form</span>
          </div>
          <h1 className="text-2xl font-bold text-foreground flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-[var(--accent)]/10 flex items-center justify-center text-[var(--accent)]">
              <FileText className="w-4 h-4" />
            </div>
            MD-26 Form Generation
          </h1>
          <p className="text-sm text-muted mt-1">
            Grant of permission to conduct post-market clinical investigation. Download the required templates below.
          </p>
        </div>
      </div>
      ...
      <div className="bg-surface border border-border rounded-2xl p-6 shadow-sm">
        ...
        <p className="text-sm text-muted mb-6">
          This will generate a complete set of MD-26 post-market clinical investigation application templates bundled into a single ZIP archive.
        </p>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {[
              "01_MD-26_Cover_Letter_Template.docx",
              "02_Official_Form_MD-26_Template.docx",
              "03_MD-26_Device_Classification_Justification_Template.docx",
              "04_MD-26_Design_Analysis_and_VV_Report_Template.docx",
              "05_MD-26_Essential_Principles_Checklist_Template.docx",
              "06_MD-26_Risk_Management_Report_Template.docx",
              "07_MD-26_Proposed_IFU_Template.docx",
              "08_MD-26_Proposed_Labelling_Specification_Template.docx",
              "09_MD-26_Clinical_Investigation_Report_Template.docx",
              "10_MD-26_Stability_Study_Report_Conditional_Template.docx",
              "11_MD-26_Biocompatibility_and_Animal_Performance_Conditional_Template.docx",
              "12_MD-26_Regulatory_Market_PMS_and_Indian_Population_Conditional_Template.docx",
              "13_MD-26_Clinical_Investigation_Waiver_Request_Conditional_Template.docx",
              "14_MD-26_Post_Marketing_Clinical_Investigation_Undertaking_Conditional_Template.docx",
              "15_MD-26_Drug_Device_Combination_Data_Conditional_Template.docx"
            ].map((filename, i) => (
