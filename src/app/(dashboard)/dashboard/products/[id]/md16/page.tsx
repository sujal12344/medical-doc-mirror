...
import PrintButton from "../md14/PrintButton";

export async function generateMetadata({ params }: { params: Promise<{ id: string }> }) {
  const { id } = await params;
  return { title: `Form MD-16 — Manufacturing License Application | SwayamSutra` };
}

export default async function FormMD16Page({ params }: { params: Promise<{ id: string }> }) {
  const { id } = await params;
    ...
    <div className="p-6 md:p-8 max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-8 print:hidden">
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-foreground">Form MD-16</h1>
          </div>
          <p className="text-sm text-muted mt-1 ml-11">
            Application for grant of licence to manufacture for sale or for distribution of medical device
          </p>
        </div>
        <PrintButton />
      </div>
      ...
      <div className="bg-white text-black p-10 border border-gray-300 shadow-sm print:border-none print:shadow-none print:p-0">
        <div className="text-center mb-8 font-serif">
          <h2 className="text-xl font-bold underline mb-2">FORM MD-16</h2>
          <p className="text-sm">[See sub-rule (2) of rule 39]</p>
          <p className="text-base font-bold mt-4">Application for grant of licence to manufacture for sale or for distribution of medical device</p>
        </div>
        ...
        <div className="space-y-6 text-sm font-serif leading-relaxed">
          ...
          <div className="flex gap-4">
            ...
            <div className="w-full">
              <p>State whether the applicant is the manufacturer or his authorised agent:</p>
              <p className="font-semibold border-b border-gray-400 block w-full mt-1 min-h-[24px]">
                Manufacturer
              </p>
            </div>
          ...
          <div className="flex gap-4">
            ...
            <div className="w-full">
              ...
              <div className="grid grid-cols-2 gap-4 mt-1">
                ...
                <p className="font-semibold border-b border-gray-400">Address: {td.sec3?.manufacturingSite || "____________________"}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div className="w-full">
              <p>Details of medical device(s) to be manufactured:</p>
