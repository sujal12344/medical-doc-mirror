...
export const coiResolvers: Record<string, ResolverFn> = {
  ...
  registeredOfficeAddress: (ctx) => ctx.coi?.registeredOfficeAddress || ctx.coi?.registeredAddress || '',
  sponsorAddress: (ctx) => ctx.coi?.registeredOfficeAddress || ctx.coi?.registeredAddress || '',
  correspondenceAddress: (ctx) => ctx.coi?.registeredOfficeAddress || ctx.coi?.registeredAddress || '',
  ...
  applicationPlace: (ctx) => extractPlaceFromAddress(ctx.coi?.registeredOfficeAddress || ctx.coi?.registeredAddress),
  pinCode: (ctx) => extractPinCode(ctx.coi?.registeredOfficeAddress || ctx.coi?.registeredAddress),
  state: (ctx) => extractState(ctx.coi?.registeredOfficeAddress || ctx.coi?.registeredAddress),
